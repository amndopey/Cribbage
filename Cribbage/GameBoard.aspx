...
<body>
    <form id="form1" runat="server">
        ...
        <div id="PlayerCard1Div" runat="server">
            <asp:ImageButton ID="PlayerCard1" runat="server" CommandName="1" Enabled="false" OnCommand="CardClick" Visible="false" />
        </div>
        <div id="PlayerCard2Div" runat="server">
            <asp:ImageButton ID="PlayerCard2" runat="server" OnCommand="CardClick" CommandName="2" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard3Div" runat="server">
            <asp:ImageButton ID="PlayerCard3" runat="server" OnCommand="CardClick" CommandName="3" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard4Div" runat="server">
            <asp:ImageButton ID="PlayerCard4" runat="server" OnCommand="CardClick" CommandName="4" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard5Div" runat="server">
            <asp:ImageButton ID="PlayerCard5" runat="server" OnCommand="CardClick" CommandName="5" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard6Div" runat="server">
            <asp:ImageButton ID="PlayerCard6" runat="server" OnCommand="CardClick" CommandName="6" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard7Div" runat="server">
            <asp:ImageButton ID="PlayerCard7" runat="server" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard8Div" runat="server">
            <asp:ImageButton ID="PlayerCard8" runat="server" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard9Div" runat="server">
            <asp:ImageButton ID="PlayerCard9" runat="server" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard10Div" runat="server">
            <asp:ImageButton ID="PlayerCard10" runat="server" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard11Div" runat="server">
            <asp:ImageButton ID="PlayerCard11" runat="server" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard12Div" runat="server">
            <asp:ImageButton ID="PlayerCard12" runat="server" Enabled="false" Visible="false" />
        </div>
        <div id="PlayerCard13Div" runat="server">
            <asp:ImageButton ID="PlayerCard13" runat="server" Enabled="false" Visible="false" />
        </div>
        <div id="CribDiv" runat="server">
            <asp:Image ID="CribCard1" runat="server" CssClass="CardBacks" Visible="false" />
            <asp:Image ID="CribCard2" runat="server" CssClass="CardBacks" Visible="false" />
            <asp:Image ID="CribCard3" runat="server" CssClass="CardBacks" Visible="false" />
            <asp:Image ID="CribCard4" runat="server" CssClass="CardBacks" Visible="false" />
        </div>
